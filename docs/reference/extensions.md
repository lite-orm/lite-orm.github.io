...
For the top-level mental model and a decision diagram, start with [Choosing a Value or Row Mapping](https://github.com/lite-orm/lite-orm/blob/main/docs/user/core/mapping.md). This document owns the precise validation and lifecycle contracts.
...
Standard route ownership and metadata are defined by [the Core contract](https://github.com/lite-orm/lite-orm/blob/main/docs/reference/core-contract.md#25-standard-jdbc-type-routing). At execution time:
